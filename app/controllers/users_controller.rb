class UsersController < ApplicationController
  ...
  def update_comedian
    ...
    the_user.comedian_name = params.fetch("query_name")
    the_user.city = params.fetch("query_city")
    the_user.state = params.fetch("query_state")
    the_user.comedian_bio = params.fetch("query_bio")
    the_user.short_comedian_bio = params.fetch("query_short_bio")
    if the_user.valid?
      the_user.save
  ...
  def update_producer
    ...
    the_user.producer_name = params.fetch("query_name")
    the_user.city = params.fetch("query_city")
    the_user.state = params.fetch("query_state")
    the_user.producer_bio = params.fetch("query_bio")
    if the_user.valid?
      the_user.save
